	...
	<div align="center">
		<form>
			...
			<table class="table table-dark" border='1'>
				...
				<hr/>
				<c:forEach begin="0" end="10" step="1" items="${houses }" var="houseInfo">
					<tr>
						<td>${houseInfo.no }</td>
						<td>${houseInfo.dong }</td>
						<td><a href="<c:url value='/house/detail?no=${houseInfo.no}' />">${houseInfo.aptName}</a></td>
						<td>${houseInfo.jibun }</td>
						<td>${houseInfo.subway }역</td>
					</tr>
				</c:forEach>
			</table>
		</form>
