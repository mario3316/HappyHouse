...
<c:if test="${userinfo != null && userinfo.role == 'admin'}">
<!DOCTYPE html>
<html lang="ko">
<head>
...
<div class="container" align="center">
	...
	<!-- 회원등록 버튼 -->
	<div align="right"><button type="button" class="modiBtn btn btn-outline-info" data-toggle="modal" data-target="#userRegModal">등록</button></div><br>
